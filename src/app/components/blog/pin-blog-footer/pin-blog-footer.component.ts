...
@Component({
  selector: 'app-pin-blog-footer',
  templateUrl: './pin-blog-footer.component.html',
  styleUrls: ['./pin-blog-footer.component.scss']
})
export class PinBlogFooterComponent implements OnInit {
